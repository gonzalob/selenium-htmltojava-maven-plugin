...
driver = new org.openqa.selenium.remote.RemoteWebDriver(new java.net.URL("http://localhost:4444/wd/hub"), custom);
...
selenium = new org.openqa.selenium.WebDriverBackedSelenium(driver, "localhost")"""
	...
	@Test void startInitializesSpeedAndTimeouts() {
...
selenium = new org.openqa.selenium.WebDriverBackedSelenium(driver, "localhost")"""
	...
	@Test void declaresTheDriverVariable() {
		assertThat new RemoteWebDriverBackedSeleniumBuilder(WHATEVER, WHATEVER, WHATEVER, WHATEVER).instanceVariables(),
			Matchers.containsString("org.openqa.selenium.WebDriver driver;")
	}
}
